...
export const metadata: Metadata = {
  title: 'Services — Ommore',
  description:
    'Business setup (UK company, US LLC, tax, banking), technology (web development, WordPress, Shopify, programming, SaaS), and marketing (SEO, Google Ads, Pinterest, YouTube, branding) for growing businesses.',
};

export default function ServicesPage() {
  return (
    <section className="mx-auto max-w-[1280px] px-20 py-24 max-md:px-5 max-md:py-16">
      <SectionHeading eyebrow="Our Services" heading="Everything Your Business Needs to Grow" />
      <ServicesGrid />
    </section>
  );
}